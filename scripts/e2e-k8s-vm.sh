...
vm_exec "cd ${REMOTE_DIR} && sudo docker build -t mcfaas/control-plane:0.1.0 control-plane/"
vm_exec "cd ${REMOTE_DIR} && sudo docker build -t mcfaas/function-runtime:0.1.0 function-runtime/"
...
vm_exec "sudo docker save mcfaas/control-plane:0.1.0 -o /tmp/control-plane.tar"
vm_exec "sudo docker save mcfaas/function-runtime:0.1.0 -o /tmp/function-runtime.tar"
